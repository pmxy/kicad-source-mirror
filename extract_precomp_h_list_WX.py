...
#    include_regexp_gcc = re.compile('^(\.+) (.*)')
    ...
    #HACK  : pmx-2021.06.30 Kicad uses local version of GLEW
    # glew.h MUST be include before wxWidget OpenGL headers.
   # the glew.h files MUST  be included in a perticular order.
   # Local headers are excluded from the precompiled header, exception
   # for GLEW

   # We write  the headers at the top of the file, to  make wxWidget happy
   print("#include \"../..//thirdparty/glew/include/GL/eglew.h\"")
   print("#include \"../..//thirdparty/glew/include/GL/glxew.h\"")
   print("#include \"../..//thirdparty/glew/include/GL/glew.h\"")
